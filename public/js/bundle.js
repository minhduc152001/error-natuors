...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWluaGR1YzE1MjAwMSIsImEiOiJjbDBmZjFtZHIwcjF6M2RsY3p0aWloeHByIn0.p-NA3m8WaS4N5IFXXczSbA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/mapbox/light-v10',
    // style URL
    scrollZoom: false // center: [105.8407837, 20.9967994], // starting position [lng, lat]
